...
class NavigationUnit:
    ...
    def update(self):
        ...
        speed = self._perception_unit.observed_speed() or 4.0  # Default speed for testing
...
class KalmanFilter:
    ...
    process_variance=1e-5, measurement_variance=0.1, threshold=0.5
    """

    def __init__(self, process_variance=1e-4, measurement_variance=0.1, threshold=2.5):
