...
class InfoFrame(Frame, object):
    ...
    def __init__(self, master, view_controller):
        ...
        Label(self, textvariable=view_controller.model.navigation_KPK).grid(row=8, column=1)
...
class ControlsFrame(Frame, object):
    ...
    def __init__(self, master, view_controller):
        ...
        self.gainp_slider = Scale(self, from_=0, to=1, orient=HORIZONTAL, resolution=0.01, showvalue=True, command=self.update_pid_values)
        self.gainp_slider.set(0.80)  # Standardwert Kp
        ...
        self.gaind_slider = Scale(self, from_=0, to=1, orient=HORIZONTAL, resolution=0.01, showvalue=True, command=self.update_pid_values)
